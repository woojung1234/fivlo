...
import { View, Text, StyleSheet, ScrollView, Alert, TouchableOpacity, ActivityIndicator, Modal, TextInput } from 'react-native';
          ...
          <View style={styles.aiRecommendationsContainer}>
            ...
            {isContinuous ? (
              ...
              <View style={styles.weeklyGoalsPlaceholder}>
                <Text style={styles.placeholderText}>주차별 목표 및 일정이 여기에 표시됩니다.</Text>
                <Text style={styles.placeholderText}>많이 뜨면 아래쪽 스크롤로 내리며 확인 가능.</Text>
