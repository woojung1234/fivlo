    ...
    <View style={[styles.screenContainer, { paddingTop: insets.top + 20 }]}>
      ...
      <ScrollView contentContainerStyle={styles.scrollViewContentContainer}>
        ...
        <View style={styles.actionButtonContainer}>
          <Button title="5분 뒤 다시" onPress={() => Alert.alert('알림', '5분 뒤 다시 알림을 보냅니다.')} primary={false} style={styles.actionButton} />
          <Button title="오늘은 안 챙겨도 됨" onPress={() => Alert.alert('알림', '오늘 알림을 무시합니다.')} primary={false} style={styles.actionButton} />
        </View>
      </ScrollView>
