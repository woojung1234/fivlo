        ...
        <View style={styles.confirmModalOverlay}>
          <View style={styles.confirmModalContent}>
            ...
            <View style={styles.confirmModalButtons}>
              <Button title="취소" onPress={() => setIsPurchaseConfirmModalVisible(false)} primary={false} style={styles.confirmButton} />
              <Button title="구매하기" onPress={confirmPurchase} style={styles.confirmButton} />
            </View>
          </View>
        </View>
      </Modal>
