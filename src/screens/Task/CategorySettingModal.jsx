...
const CategorySettingModal = ({ onSave, onClose }) => {
  ...
  const onCategoryEditSave = (updatedCategory) => {
    ...
    // 실제로는 백엔드 업데이트
    Alert.alert('카테고리 저장', `카테고리가 ${mode === 'add' ? '추가' : '수정'}되었습니다.`);
  };
  ...
  return (
    <View style={styles.overlay}>
      <View style={styles.modalContent}>
        ...
        <Button title="새 카테고리 추가" onPress={handleAddCategory} style={styles.addButton} />
        <Button title="닫기" onPress={onClose} primary={false} style={styles.closeButton} />
      </View>
